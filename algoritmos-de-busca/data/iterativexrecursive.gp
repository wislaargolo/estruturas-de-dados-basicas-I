...
# ---------------------------------
set title "[Iterativa vs. Recursiva] Comparação da velocidade dos algoritmos de Busca Binária" font ", 32"
...
plot 'bsearch_it/media.txt' u 1:2 title 'Busca binária iterativa' w lp ls 3, \
     'bsearch_rec/media.txt' u 1:2 title 'Busca binária recursiva' w lp ls 5
